...
\equation{Y_u = \frac{{0.87 \epsilon}L^2{R_{avg}}}
Where: \equation{Y_u} is the deflection, \equation{\epsilon} is the strain, \equation{L} is the cut length and \equation{R_{avg}} is the cross-section radius. 
